        ...
        <div class="card-body">
            <form action="{{ route('kasir.update',$dataKasir->id) }}" method="post">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="username" class="form-control" id="username" value="{{$dataKasir->username}}" autofocus>
                </div>
                <div class="mb-3">
                    <label for="email">email</label>
                    <input type="text" name="email" class="form-control" id="email" value="{{$dataKasir->email}}" autofocus>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="number" name="telepon" class="form-control" id="telepon" value="{{$dataKasir->telepon}}" autofocus>
                </div>
                <div class="mb-3">
                    <label for="alamat">Alamat</label>
                    <textarea class="form-control" name="alamat" id="alamat" rows="3">{{$dataKasir->alamat}}</textarea>
